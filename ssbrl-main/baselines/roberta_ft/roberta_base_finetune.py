...
tokenizer = AutoTokenizer.from_pretrained("Ruipeng/roberta-base-ep300-lr0005", token=access_token)
model = AutoModelForSequenceClassification.from_pretrained("Ruipeng/roberta-base-ep300-lr0005", token=access_token)

config = AutoConfig.from_pretrained("Ruipeng/roberta-base-ep300-lr0005")
...
def run(args):
    ...
    file_path = os.path.join(folder_path, f"{args.topic}_t_roberta_ft_res.csv")
