...
def evaluate(result_path, topic, model):
    ...
    # Set ft_label to the opposite of manual_label for rows where ft_label is "neutral"
    ...
    # Extract "manual_label" as ground truth and "ft_label" as predictions
...
def batch_run_eval_gpt(args):
    ...
    model = args.model
    command = f"python3 /Users/ruipenghan/projects/research/ssbrl/baselines/tweet_roberta_ft/tweet_roberta_finetune_inference.py" \
